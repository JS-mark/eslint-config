...
export async function typescript(
  ...
  function makeParser(typeAware: boolean, files: string[], ignores?: string[]): FlatConfigItem {
    return {
      ...
      name: `tm2js:typescript:${typeAware ? 'type-aware-parser' : 'parser'}`,
    }
  }
  ...
  return [
    ...
    },
    {
      ...
      name: 'tm2js:typescript:rules-type-aware',
      rules: {
    ...
    {
      files: ['**/*.d.ts'],
      name: 'tm2js:typescript:dts-overrides',
      rules: {
    ...
    },
    {
      ...
      name: 'tm2js:typescript:tests-overrides',
      rules: {
    ...
    {
      files: ['**/*.js', '**/*.cjs'],
      name: 'tm2js:typescript:javascript-overrides',
      rules: {
